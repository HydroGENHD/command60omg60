...
//xynexcode
    ...
    const lates = await db.fetch(
      `afkSebep_${message.author.id}_${message.guild.id}`
    );
//wynexcode

   message.channel.send(new MessageEmbed().setColor('BLACK').setDescription(`${kullanıcı} Başarıyla Afk Oldunuz Afk Olmanızın Sebebi: **${lates}**`));
//xynexcode
